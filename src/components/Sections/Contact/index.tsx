      ...
      <div className="flex flex-col gap-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="order-1 col-span-1 flex flex-col gap-y-4 md:order-2">
            ...
            <dl className="flex flex-col space-y-4 text-base text-neutral-900 sm:space-y-2">
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-600 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500',
                          {'hover:text-black': href},
                        )}
                        href={href}
                        target="_blank">
                        <Icon aria-hidden="true" className="h-4 w-4 flex-shrink-0 text-neutral-900 sm:h-5 sm:w-5" />
